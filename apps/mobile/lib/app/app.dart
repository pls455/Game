...
class _SplashGateState extends State<SplashGate> {
  ...
  Widget build(BuildContext context) {
    ...
    if (session == null) {
      return AuthScreen(auth: auth, onDone: _restore);
    }
    if (store == null) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    child: Text(
                      register ? 'عندي حساب، بدي أدخل' : 'إنشاء حساب جديد',
                    ),
                  ),
                ],
              ),
      ...
      body: ListView(
        ...
        children: [
          ...
          TextField(
            ...
            decoration: const InputDecoration(
              labelText: 'المنطقة / العنوان (اختياري)',
          ...
          FilledButton(
            ...
            child: Text(busy ? 'بحفظ...' : 'ابدأ دَكانتك'),
          ),
        ],
      ),
    );
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadCustomers() async {
    final result = await customerRepository.list(
      widget.store.id,
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(labelText: 'رصيد افتتاحي'),
              ),
              const SizedBox(height: 16),
              FilledButton(
                onPressed: () async {
